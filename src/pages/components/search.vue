<template>
  <div class="search" v-click-outside="removeStyle">
      ...
      <div ref="boxRef" class="list">
        <div v-for="item in selectList" :key="item.icon" class="item" @click="changeSearchIcon(item)">
          <i title="删除" class="delete">
            <svg t="1737611789917" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              p-id="4181" width="12" height="12">
              <path
...
<script lang="ts" setup>
  ...
  function removeStyle() {
    boxRef.value?.classList.remove('list-active');
  }
